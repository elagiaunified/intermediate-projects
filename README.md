...
A collection of intermediate-level web applications that demonstrate advanced JavaScript concepts, API integration, and modern UI/UX design.
...
This repository focuses on **intermediate to advanced web development skills**:

### **🌐 API Integration**
- Consuming REST APIs with Fetch/Async-Await
